...
<div class="projects">
  ...
  <section class="project-row social neuro">
    ...
    <div class="project-text">
      ...
      <p>
        This study investigated how the brain models a friend’s perspective across different targets. Participants made judgments about themselves and the president, from both their own perspective and that of a friend. Whole-brain searchlight RSA identified brain regions whose activity patterns reflected the friend’s perspective. ROI-based MVPA then tested cross-condition generalization, examining whether classifiers trained on self-related judgments could also decode president-related judgments.
      </p>
    </div>
  </section>
